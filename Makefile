...
cc: ## Clear Laravel caches and dump autoload
	docker exec -it $(php) bash -c "composer dumpautoload -a && php artisan config:clear && php artisan cache:clear && php artisan view:clear"
